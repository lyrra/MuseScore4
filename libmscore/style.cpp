...
//      { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
    ...
    { Sid::albumFrontTitleFontFace,              "albumFrontTitleFontFace",     "FreeSerif" },
    { Sid::albumFrontTitleFontSize,              "albumFrontTitleFontSize",     36.0 },
    ...
    { Sid::albumFrontTitleFrameType,             "albumFrontTitleFrameType",    int(FrameType::NO_FRAME) },
    { Sid::albumFrontTitleFramePadding,          "albumFrontTitleFramePadding", 0.2 },
    { Sid::albumFrontTitleFrameWidth,            "albumFrontTitleFrameWidth",   0.1 },
    { Sid::albumFrontTitleFrameRound,            "albumFrontTitleFrameRound",   0 },
    { Sid::albumFrontTitleFrameFgColor,          "albumFrontTitleFrameFgColor", QColor(0, 0, 0, 255) },
    ...
    { Sid::albumFrontComposerPosBelow,              "albumFrontComposerPosBelow",     QPointF(.0, 2.0) },
    { Sid::albumFrontComposerMinDistance,           "albumFrontComposerMinDistance",  Spatium(0.5) },
    { Sid::albumFrontComposerFrameType,             "albumFrontComposerFrameType",    int(FrameType::NO_FRAME) },
    { Sid::albumFrontComposerFramePadding,          "albumFrontComposerFramePadding", 0.2 },
    { Sid::albumFrontComposerFrameWidth,            "albumFrontComposerFrameWidth",   0.1 },
    { Sid::albumFrontComposerFrameRound,            "albumFrontComposerFrameRound",   0 },
    { Sid::albumFrontComposerFrameFgColor,          "albumFrontComposerFrameFgColor", QColor(0, 0, 0, 255) },
    ...
    { Sid::albumFrontLyricistPosBelow,              "albumFrontLyricistPosBelow",     QPointF(.0, 2.0) },
    { Sid::albumFrontLyricistMinDistance,           "albumFrontLyricistMinDistance",  Spatium(0.5) },
    { Sid::albumFrontLyricistFrameType,             "albumFrontLyricistFrameType",    int(FrameType::NO_FRAME) },
    { Sid::albumFrontLyricistFramePadding,          "albumFrontLyricistFramePadding", 0.2 },
    { Sid::albumFrontLyricistFrameWidth,            "albumFrontLyricistFrameWidth",   0.1 },
    { Sid::albumFrontLyricistFrameRound,            "albumFrontLyricistFrameRound",   0 },
    { Sid::albumFrontLyricistFrameFgColor,          "albumFrontLyricistFrameFgColor", QColor(0, 0, 0, 255) },
    ...
    { Sid::albumContentsTitlePosBelow,              "albumContentsTitlePosBelow",     QPointF(.0, 2.0) },
    { Sid::albumContentsTitleMinDistance,           "albumContentsTitleMinDistance",  Spatium(0.5) },
    { Sid::albumContentsTitleFrameType,             "albumContentsTitleFrameType",    int(FrameType::NO_FRAME) },
    { Sid::albumContentsTitleFramePadding,          "albumContentsTitleFramePadding", 0.2 },
    { Sid::albumContentsTitleFrameWidth,            "albumContentsTitleFrameWidth",   0.1 },
    { Sid::albumContentsTitleFrameRound,            "albumContentsTitleFrameRound",   0 },
    { Sid::albumContentsTitleFrameFgColor,          "albumContentsTitleFrameFgColor", QColor(0, 0, 0, 255) },
    ...
    { Sid::albumContentsTextMinDistance,           "albumContentsTextMinDistance",  Spatium(0.5) },
    { Sid::albumContentsTextFrameType,             "albumContentsTextFrameType",    int(FrameType::NO_FRAME) },
    { Sid::albumContentsTextFramePadding,          "albumContentsTextFramePadding", 0.2 },
    { Sid::albumContentsTextFrameWidth,            "albumContentsTextFrameWidth",   0.1 },
    { Sid::albumContentsTextFrameRound,            "albumContentsTextFrameRound",   0 },
    { Sid::albumContentsTextFrameFgColor,          "albumContentsTextFrameFgColor", QColor(0, 0, 0, 255) },
    { Sid::albumContentsTextFrameBgColor,          "albumContentsTextFrameBgColor", QColor(255, 255, 255, 0) },
...
const TextStyle albumFrontTitleTextStyle { {
    { Sid::albumFrontTitleFontFace,                   Pid::FONT_FACE },
    { Sid::albumFrontTitleFontSize,                   Pid::FONT_SIZE },
    { Sid::albumFrontTitleFontSpatiumDependent,       Pid::SIZE_SPATIUM_DEPENDENT },
    { Sid::albumFrontTitleFontStyle,                  Pid::FONT_STYLE },
    { Sid::albumFrontTitleColor,                      Pid::COLOR },
    { Sid::albumFrontTitleAlign,                      Pid::ALIGN },
    { Sid::albumFrontTitleOffset,                     Pid::OFFSET },
    { Sid::albumFrontTitleFrameType,                  Pid::FRAME_TYPE },
    { Sid::albumFrontTitleFramePadding,               Pid::FRAME_PADDING },
    { Sid::albumFrontTitleFrameWidth,                 Pid::FRAME_WIDTH },
    { Sid::albumFrontTitleFrameRound,                 Pid::FRAME_ROUND },
    { Sid::albumFrontTitleFrameFgColor,               Pid::FRAME_FG_COLOR },
    { Sid::albumFrontTitleFrameBgColor,               Pid::FRAME_BG_COLOR },
} };

const TextStyle albumFrontComposerTextStyle { {
    { Sid::albumFrontComposerFontFace,                   Pid::FONT_FACE },
    { Sid::albumFrontComposerFontSize,                   Pid::FONT_SIZE },
    { Sid::albumFrontComposerFontSpatiumDependent,       Pid::SIZE_SPATIUM_DEPENDENT },
    { Sid::albumFrontComposerFontStyle,                  Pid::FONT_STYLE },
    { Sid::albumFrontComposerColor,                      Pid::COLOR },
    { Sid::albumFrontComposerAlign,                      Pid::ALIGN },
    { Sid::albumFrontComposerOffset,                     Pid::OFFSET },
    { Sid::albumFrontComposerFrameType,                  Pid::FRAME_TYPE },
    { Sid::albumFrontComposerFramePadding,               Pid::FRAME_PADDING },
    { Sid::albumFrontComposerFrameWidth,                 Pid::FRAME_WIDTH },
    { Sid::albumFrontComposerFrameRound,                 Pid::FRAME_ROUND },
    { Sid::albumFrontComposerFrameFgColor,               Pid::FRAME_FG_COLOR },
    { Sid::albumFrontComposerFrameBgColor,               Pid::FRAME_BG_COLOR },
} };

const TextStyle albumFrontLyricistTextStyle { {
    { Sid::albumFrontLyricistFontFace,                   Pid::FONT_FACE },
    { Sid::albumFrontLyricistFontSize,                   Pid::FONT_SIZE },
    { Sid::albumFrontLyricistFontSpatiumDependent,       Pid::SIZE_SPATIUM_DEPENDENT },
    { Sid::albumFrontLyricistFontStyle,                  Pid::FONT_STYLE },
    { Sid::albumFrontLyricistColor,                      Pid::COLOR },
    { Sid::albumFrontLyricistAlign,                      Pid::ALIGN },
    { Sid::albumFrontLyricistOffset,                     Pid::OFFSET },
    { Sid::albumFrontLyricistFrameType,                  Pid::FRAME_TYPE },
    { Sid::albumFrontLyricistFramePadding,               Pid::FRAME_PADDING },
    { Sid::albumFrontLyricistFrameWidth,                 Pid::FRAME_WIDTH },
    { Sid::albumFrontLyricistFrameRound,                 Pid::FRAME_ROUND },
    { Sid::albumFrontLyricistFrameFgColor,               Pid::FRAME_FG_COLOR },
    { Sid::albumFrontLyricistFrameBgColor,               Pid::FRAME_BG_COLOR },
} };

const TextStyle albumContentsTitleTextStyle { {
    { Sid::albumContentsTitleFontFace,                   Pid::FONT_FACE },
    { Sid::albumContentsTitleFontSize,                   Pid::FONT_SIZE },
    { Sid::albumContentsTitleFontSpatiumDependent,       Pid::SIZE_SPATIUM_DEPENDENT },
    { Sid::albumContentsTitleFontStyle,                  Pid::FONT_STYLE },
    { Sid::albumContentsTitleColor,                      Pid::COLOR },
    { Sid::albumContentsTitleAlign,                      Pid::ALIGN },
    { Sid::albumContentsTitleOffset,                     Pid::OFFSET },
    { Sid::albumContentsTitleFrameType,                  Pid::FRAME_TYPE },
    { Sid::albumContentsTitleFramePadding,               Pid::FRAME_PADDING },
    { Sid::albumContentsTitleFrameWidth,                 Pid::FRAME_WIDTH },
    { Sid::albumContentsTitleFrameRound,                 Pid::FRAME_ROUND },
    { Sid::albumContentsTitleFrameFgColor,               Pid::FRAME_FG_COLOR },
    { Sid::albumContentsTitleFrameBgColor,               Pid::FRAME_BG_COLOR },
} };

const TextStyle albumContentsTextTextStyle { {
    { Sid::albumContentsTextFontFace,                   Pid::FONT_FACE },
    { Sid::albumContentsTextFontSize,                   Pid::FONT_SIZE },
    { Sid::albumContentsTextFontSpatiumDependent,       Pid::SIZE_SPATIUM_DEPENDENT },
    { Sid::albumContentsTextFontStyle,                  Pid::FONT_STYLE },
    { Sid::albumContentsTextColor,                      Pid::COLOR },
    { Sid::albumContentsTextAlign,                      Pid::ALIGN },
    { Sid::albumContentsTextOffset,                     Pid::OFFSET },
    { Sid::albumContentsTextFrameType,                  Pid::FRAME_TYPE },
    { Sid::albumContentsTextFramePadding,               Pid::FRAME_PADDING },
    { Sid::albumContentsTextFrameWidth,                 Pid::FRAME_WIDTH },
    { Sid::albumContentsTextFrameRound,                 Pid::FRAME_ROUND },
    { Sid::albumContentsTextFrameFgColor,               Pid::FRAME_FG_COLOR },
...
// Album
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Title"),       "album_front_title",    &albumFrontTitleTextStyle,     Tid::ALBUM_FRONT_TITLE },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Composer"),    "album_front_composer", &albumFrontComposerTextStyle,  Tid::ALBUM_FRONT_COMPOSER },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Lyricist"),    "album_from_lyricist",  &albumFrontLyricistTextStyle,  Tid::ALBUM_FRONT_LYRICIST },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Contents Title"),    "album_contents_title", &albumContentsTitleTextStyle,  Tid::ALBUM_CONTENTS_TITLE },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Contents Text"),     "album_contents_text",  &albumContentsTextTextStyle,   Tid::ALBUM_CONTENTS_TEXT },
// User styles
